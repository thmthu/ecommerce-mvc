$(document).ready(function () {
  ...
  $("#tested-button").click(function () {
    const requestData = {
      amountInput: 100000, // Hardcoded value
      contentPayment: "Payment for order", // Hardcoded value
      productTypeSelect: "electronics", // Hardcoded value
      bankSelect: "VCB", // Hardcoded value
      langSelect: "en", // Hardcoded value
    };
